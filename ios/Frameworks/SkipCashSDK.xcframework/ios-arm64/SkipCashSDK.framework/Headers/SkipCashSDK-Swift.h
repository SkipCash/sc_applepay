...
#ifndef SKIPCASHSDK_SWIFT_H
#define SKIPCASHSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SkipCashSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11SkipCashSDK12ResponseData")
...
SWIFT_CLASS("_TtC11SkipCashSDK7SetupVC")
